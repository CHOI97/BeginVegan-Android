...
//import com.example.data.model.auth.Auth
...
//    com.example.data.model.auth.AuthSignInterface, UserCheckInterface {
...
//    }
//
//    private fun setUserData(response: com.example.data.model.auth.AuthResponse) {
...
//        ApplicationClass.xAuth = com.example.data.model.auth.Auth(
//            response.id,
//            response.name,
//            response.email,
//            response.imageUrl,
