...
class NotificationNewRvAdapter(private val list:MutableList<Notification>,private val context: Context):
    RecyclerView.Adapter<NotificationNewRvAdapter.RecyclerViewHolder>(){
